...
export interface FlexipageOptions extends TemplateOptions {
  ...
  primaryFields?: string[]; // Primary fields for dynamic highlights (e.g., ['Name'])
  secondaryFields?: string[]; // Secondary fields for dynamic highlights (e.g., ['Property_Address__c', 'City__c'])
}
